...
public class StringUtil {
	...
	public static String toJSON(String[] arrString) {
		String json = "['";
		json += StringUtils.join(arrString, "','");
		json += "']";
		return json;
	}

	public static String xmlToJSStr(String xml) {
	...
	/**
	 * 주어진 스트링이 모두 한자인지 판별한다.
	 * @param in - 한자
	 * @return - 한자인지 여부
	 */
	public static boolean isHanja(String in) {
		// CJK_UNIFIED_IDEOGRAPHS , CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A, CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B 판별
