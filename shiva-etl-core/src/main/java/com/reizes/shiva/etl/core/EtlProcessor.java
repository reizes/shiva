...
import com.reizes.shiva.etl.core.extractor.Extractor;
...
public class EtlProcessor extends EtlElementListBase implements ExtractedItemHandler, BeforeProcessAware, AfterProcessAware {
	...
	public void setBeforeProcessListener(BeforeProcessListener beforeProcessListener) {
	...
	public void setAfterProcessListener(AfterProcessListener afterProcessListener) {
	...
	public void setShareProcessAware(boolean shareProcessAware) {
