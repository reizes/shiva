...
import com.reizes.shiva.etl.core.transformer.StringSplitTransformer;
...
public class RestrictStringSplitTransformer extends StringSplitTransformer implements ProcessContextAware {
	 ...
	 * @return String[]
	 * @throws Exception -
	 * @see com.reizes.shiva.etl.core.transformer.StringSplitTransformer#doProcess(java.lang.Object)
	 */
