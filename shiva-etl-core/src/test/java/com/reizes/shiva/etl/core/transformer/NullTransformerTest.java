...
import com.reizes.shiva.etl.core.AfterItemProcessListener;
import com.reizes.shiva.etl.core.BeforeItemProcessListener;
...
public class NullTransformerTest {
	...
	public void setUp() throws Exception {
		...
		for(int i=0;i<elementCount;i++) {
			EtlElement element=new NullTransformer();
